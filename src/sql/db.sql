...
insert into orders (user_id, cart_id , payment, delivery, comments, status, total)
 	values
 	('20e3ac50-cbee-4983-9d60-556bb6d08eff','dbf4a8b2-edce-46b0-a689-558cfa2faa21','{"card":"yes"}','{"address":"blabla"}','awesome','ORDERED',255),
 	('96e2b16b-c010-48a5-88cf-2e1d1d3f3a04','4ceb9aea-3051-418c-bc29-4cea330825dd','{"card":"no"}','{"address":"blabla 15"}','too long','OPEN',205),
 	('4298d62d-bb29-4373-b5d2-d399a772e03e','35925a77-698a-419b-b4bc-a93cf923e1c8','{"card":"yes"}','{"address":"blabla 25"}','expensive','ORDERED',50),
 	('5fd3ee8e-af69-4db3-8cad-6a1dcb8abf75','21fa74de-aa51-4570-b8fc-372ba17efbbb','{"card":"no"}','{"address":"blabla 45"}','great','OPEN',25),
 	('3038f47f-2715-4f99-8c51-9a18029fd53f','1951fdf1-a376-4551-955c-efa7d70c2ad8','{"card":"yes"}','{"address":"blabla 1"}','ehh','ORDERED',150)
...
insert into users (firstname ,lastname , adress, created_at)
	...
	('Piotr','Zakoscielny','blabla 25', '2020-08-11'),
